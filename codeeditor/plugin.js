...
<div id="tox-codeeditor-modal" tabindex="-1">
    <div id="tox-codeeditor-header" role="presentation">
        <div id="tox-codeeditor-modal-title">Source Code Editor</div>
    ...
    aceScript.src = "https://cdnjs.cloudflare.com/ajax/libs/ace/1.32.7/ace.js";
    ...
    beautify.src = "https://cdnjs.cloudflare.com/ajax/libs/js-beautify/1.15.1/beautify.min.js";
    beautify.crossorigin = "anonymous";
    document.body.appendChild(beautify);

    let beautifyCss = document.createElement('script');
    beautifyCss.src = "https://cdnjs.cloudflare.com/ajax/libs/js-beautify/1.15.1/beautify-css.min.js";
    beautifyCss.crossorigin = "anonymous";
    document.body.appendChild(beautifyCss);

    let beautifyHtml = document.createElement('script');
    beautifyHtml.src = "https://cdnjs.cloudflare.com/ajax/libs/js-beautify/1.15.1/beautify-html.min.js";
    beautifyHtml.crossorigin = "anonymous";
    ...
    tinymce.PluginManager.add('codeeditor', function(e) {
        ...
        e.ui.registry.addIcon('codeSlash', `
        ...
        return {
            getMetadata: function () {
                return {
                    name: "CodeEditor",
                    url: "https://github.com/western/tinymce-codeeditor"
                };
            }
        }
    });
